public class StringJazz{
  ...
  String[] startJoke = {"Why did the chicken cross the road?", "Want to know something odd?", "What do you get when you cross a mentally ill person, with a society that abandons him and treats him like trash?", "Why was six afraid of seven?", "Is your refrigerator running?"};
  String[] endJoke = {"To get to the other side!", "Numbers that aren't divisible by 2.", "You get what you hecking deserve!", "Because seven eight nine!", "Then you better go catch it!"};
